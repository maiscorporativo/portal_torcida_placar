  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: '4px',
        height: '50px',
        background: 'linear-gradient(to top, transparent, #DFFE00)',
        bottom: '50%',
        left: 'calc(50% - 2px)',
      ...
      <div style={{ position: 'absolute', bottom: '15px', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '10px', fontWeight: 800, color: '#DFFE00', letterSpacing: '1px' }}>KM/H</div>
      </div>
    </div>
  );
}
